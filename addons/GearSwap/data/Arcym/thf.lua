...
function init_gear_sets()
    ...
    sets.precast.WS = {
		--ammo="Focal orb", --DA 2%, Att +10, Acc -10
		ammo="Aurgelmir orb", --STR +5, DEX +5, VIT +5, Att +7, STP +4
    ...
    sets.idle = {
		...
		legs="Nyame flanchard", --DT -8, MEva +150
    ...
    sets.engaged = {
        ...
        --head="Skulker's bonnet +3", --Haste 8%, DEX +43, Acc +61, TA 6%, PDL 10%
		neck="Assassin's gorget +2", 
		ear1="Sherida earring", --DEX +5, Store TP +5, SB2 +5, DA 5%, STR +5
		ear2="Skulker's earring +1", --STP+3, TA+4%, Acc+11, SB+6
...
function fashion_particulars()
	send_command('wait 1;input /lockstyleset 24;wait 1;input /lockstyle on;wait 1;gs equip sets.idle;wait 1;gs c set treasuremode Fulltime')
end
-------------------------------------------------------------------------------------------------------------------
