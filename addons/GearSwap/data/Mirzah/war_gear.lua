...
function user_setup()
	...
	state.IdleMode:options('SpeedCP','PDT')
...
function init_gear_sets()
    ...
    sets.precast.WS = {ammo="Breeze sachet",
		head="Senshin Hachimaki",neck="Peacock amulet",ear1="Pagondas earring",ear2="Bone earring",
		body="Fighter's lorica",hands="Fighter's mufflers",ring1="Amber ring",ring2="Clear ring",
		back="Dhalmel mantle",waist="Warwolf belt",legs="Fighter's cuisses",feet="Fighter's calligae"}
    ...
    -- Idle sets
    sets.idle = {ammo="Breeze sachet",
		head="Senshin Hachimaki",neck="Peacock amulet",ear1="Pagondas earring",ear2="Bone earring",
		body="Fighter's lorica",hands="Fighter's mufflers",ring1="Amber ring",ring2="Clear ring",
		back="Dhalmel mantle",waist="Ninurta's sash",legs="Fighter's cuisses",feet="Fighter's calligae"}
		
	sets.SpeedCP = set_combine(sets.idle, {})
    ...
    -- Normal melee sets
    sets.engaged = {ammo="Breeze sachet",
		head="Senshin Hachimaki",neck="Peacock amulet",ear1="Pagondas earring",ear2="Bone earring",
		body="Fighter's lorica",hands="Fighter's mufflers",ring1="Amber ring",ring2="Clear ring",
		back="Dhalmel mantle",waist="Ninurta's sash",legs="Fighter's cuisses",feet="Fighter's calligae"}
	...
	sets.fashion.rse = {head="Senshin Hachimaki",body="Savage separates",hands="Savage gauntlets",
		legs="Savage loincloth",feet="Savage gaiters"}
		
	sets.fashion.war = {head="Senshin Hachimaki",body="Fighter's lorica",hands="Fighter's mufflers",
		legs="Fighter's cuisses",feet="Fighter's calligae"}
end
...
function fashion_particulars()
	send_command('wait 1;gs equip fashion.war;wait 1;input /lockstyle on;wait 1;gs c set IdleMode SpeedCP')
end
