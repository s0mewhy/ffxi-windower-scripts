...
function user_setup()
	state.IdleMode:options('SpeedCP', 'DT')
...
function init_gear_sets()
    ...
    sets.TreasureHunter = {}--, legs="Assassin's culottes"}
    ...
    sets.precast.JA['Steal'] = {head="Rogue's bonnet",
		hands="Rogue's armlets",feet="Rogue's poulaines"}
    ...
    -- sets.midcast.RA.Acc = {
        ...
        -- back="Libeccio Mantle",waist="Aquiline Belt",legs="Thurandaut Tights +1",feet="Rogue's poulaines +1"}
    ...
    sets.idle = {ammo="",
        head="Rogue's bonnet",neck="Peacock amulet",ear1="Cassandra's earring",ear2="Raisin earring",
        body="Rogue's vest",hands="Rogue's armlets",ring1="San d'Orian ring",ring2="Warp ring",
        back="",waist="Flagellant's rope",legs="Rogue's culottes",feet="Rogue's poulaines"}

    sets.idle.SpeedCP = set_combine(sets.idle, {feet="Rogue's poulaines"})
	...
	sets.fashion.af = {
		head="Rogue's bonnet",body="Rogue's vest",hands="Rogue's armlets",
		legs="Rogue's culottes",feet="Rogue's poulaines"}
		
	sets.fashion.rse = {
		head="",body="Elvaan bodice",hands="Elvaan gauntlets",
		legs="Elvaan F chausses",feet="Elvaan F ledelsens"}
...
function fashion_particulars()
	send_command('wait 1;gs equip fashion.af;wait 1;input /lockstyle on;wait 1;gs c set IdleMode SpeedCP;wait 1;gs c set treasuremode Fulltime')
end
-------------------------------------------------------------------------------------------------------------------
